    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-background to-muted/20 pt-20">
            <div className="container mx-auto px-4 sm:px-6 py-12 max-w-6xl">
                {/* Profile Header Card */}
                <div className="mb-8 bg-card/80 backdrop-blur-sm border border-border/50 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-8">
                    <div className="flex flex-col lg:flex-row items-start gap-8">
                        <div className="flex-1 space-y-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
                                ...
                                <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-rose-50 to-rose-100 dark:from-rose-950/30 dark:to-rose-900/30 rounded-xl border border-rose-200/50 dark:border-rose-800/50">
                                ...
                                <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-amber-50 to-amber-100 dark:from-amber-950/30 dark:to-amber-900/30 rounded-xl border border-amber-200/50 dark:border-amber-800/50">
                ...
                <div className="bg-card/80 backdrop-blur-sm border border-border/50 rounded-2xl shadow-lg p-8">
